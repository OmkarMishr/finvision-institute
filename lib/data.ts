...
export const POSTS = [
  ...
  {
    id: "trading-psychology-why-emotions-cost-more-than-bad-strategies",
    cat: "Trading Psychology",
    title: "TRADING PSYCHOLOGY: WHY EMOTIONS COST MORE THAN BAD STRATEGIES",
    subtitle: "The real reason most traders fail — and it has nothing to do with their strategy.",
    metaTitle: "Trading Psychology: Why Emotions Cost More Than Bad Strategies | FINVISION",
    metaDescription: "Discover how fear, greed, and emotional decision-making impact trading performance. Learn why trading psychology matters more than strategy for long-term success.",
    excerpt: "Many traders spend months searching for the perfect strategy, indicator, or setup. They believe the secret to success lies in finding a system that never loses. However, the reality is far different. The biggest reason traders fail is not a lack of strategy — it is a lack of emotional control.",
    read: "6 min",
    author: "Goutam Soni",
    date: "June 10, 2026",
    image: "",
  ...
  },
  {
    ...
    cat: "Trading Psychology",
    title: "RISK MANAGEMENT: THE SKILL THAT SEPARATES WINNERS FROM LOSERS",
    subtitle: "Why protecting your capital matters more than finding the perfect entry.",
    metaTitle: "Risk Management in Trading: The Skill That Separates Winners From Losers | FINVISION",
    metaDescription: "Learn why risk management in trading is the key to long-term success. Discover how professional traders protect capital, control losses, and stay profitable.",
    excerpt: "Most traders focus on finding the perfect entry. They spend countless hours studying charts, indicators, and strategies. However, professional traders understand a truth that many beginners ignore: trading success is not determined by how much you make when you're right — it's determined by how much you protect when you're wrong.",
    read: "5 min",
    author: "Goutam Soni",
    date: "June 12, 2026",
    image: "",
    body: [
      ...
      "## The Stop Loss: Your Best Defense",
      ...
      "## Common Mistakes From Poor Risk Management",
      ...
      "## The Truth About Why Traders Fail",
      ...
      "## Start With Protection, Then Profit",
  ...
  {
    id: "why-most-traders-fail",
    cat: "Trading Psychology",
    title: "THE 90% RULE: WHY MOST TRADERS FAIL",
    subtitle: "Why the majority lose — and what the minority do differently.",
    metaTitle: "Why Most Traders Fail: Understanding the 90% Rule | FINVISION",
    metaDescription: "Discover why most traders fail and how you can avoid common mistakes. Learn the importance of trading psychology, risk management, discipline, and education.",
    excerpt: "If you've spent any time in the trading world, you've probably heard the saying: '90% of traders lose money.' Most people who enter the financial markets fail — not because the market is impossible to understand, but because they underestimate what successful trading actually requires.",
    read: "5 min",
    author: "Goutam Soni",
    date: "June 14, 2026",
    image: "",
    body: [
      ...
      "## What Separates the Successful Few",
  ...
  {
    id: "why-traders-fail-how-to-be-in-the-top-10",
    cat: "Trading Psychology",
    title: "WHY 90% OF TRADERS FAIL (AND HOW TO BE IN THE 10%)",
    subtitle: "The uncomfortable truth about why most lose money — and what the top 10% do differently every single day.",
    metaTitle: "Why 90% of Traders Fail and How to Be in the 10% | FINVISION",
    metaDescription: "Discover why most traders lose money — lack of discipline, poor risk management, unrealistic expectations — and exactly how the top 10% approach the market differently.",
    excerpt: "The market took everything from me. I just needed one more trade to recover. Every losing trader has said this. And most of them never recovered.",
    read: "6 min",
    author: "Goutam Soni",
    date: "June 20, 2026",
    image: "",
    body: [
      ...
      "## Reason 03: Unrealistic Expectations",
      ...
      "## Reason 04: Trading Without a Plan",
      ...
      "## Reason 05: They Quit Before They Improve",
  ...
  {
    id: "stop-loss-best-friend-or-worst-enemy",
    cat: "Trading Psychology",
    title: "STOP LOSS: YOUR BEST FRIEND OR WORST ENEMY?",
    subtitle: "Why traders fear the stop loss — and why avoiding it is the fastest way to blow your account.",
    metaTitle: "Stop Loss: Your Best Friend or Worst Enemy? | FINVISION",
    metaDescription: "Learn why traders fear stop losses, what happens when you remove them, and how to place them smartly without getting stopped out on normal market moves.",
    excerpt: "I'll just remove my stop loss this one time. The trade will come back. It never comes back. Or at least, not before it takes everything first.",
    read: "6 min",
    author: "Akshay Sir",
    date: "June 24, 2026",
    image: "",
